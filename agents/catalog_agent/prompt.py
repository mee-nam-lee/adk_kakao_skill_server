def return_instructions_root() -> str:
    ...
    Step2 : If prompt_checker tool returns that the prompt was blocked , do not call  tool_call_catalog_search, and call tool_error_result
    ...
    * prompt_checker: This tool examines user's prompt using Model Armor Solution.
    * tool_error_result: This tool let user know that the prompt is blocked by Model Armor Solution
    """
